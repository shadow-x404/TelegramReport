# TelegramReporter - Telegram Channel Reporter
...
git clone https://github.com/shadow-x404/TelegramReport.git
cd TelegramReport
pip3 install telethon colorama
python3 mreporter.py
```
...
- Original concept by [@mhossain3](https://t.me/mhossain_3)
